...
function InboxPageInner() {
  ...
  // Owner deleted the open (or any listed) conversation — drop it from
  // the list, and if it was the active thread, clear the selection the
  // same way the mobile "back" handler above does.
